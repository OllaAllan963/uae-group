  ...
  companies: Array<ICompany> = [
    {
      ...
      descriptionAr: "مجموعة يو إيه إي للاستثمار والتطوير تربط المستثمرين العالميين بفرص الاستثمار في الخليج عبر القطاعات الرئيسية. نقدم لكم دعمًا متخصصًا وتمويلًا وشراكات استراتيجية لتنمية أعمالكم.",
    ...
    },
    {
      ...
      titleAr: 'يو إيه إي لنظم المعلومات',
