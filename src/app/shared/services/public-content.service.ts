...
export class PublicContentService {
  ...
  stats = [
    ...
    { icon: 'bi-graph-up', value: '10+', label: 'Years in Operation', labelAr: "سنوات الخبرة" }
  ];

  invExcellence = [
    { value: "+10", desc: "Years of experience", descAr: "سنوات من الخبرة" },
  ...
  ourPurpose = [
    ...
    {
      id: 2,
      title: 'Real Estate Services & Property Management',
      titleAr: 'الخدمات العقارية وإدارة الممتلكات',
